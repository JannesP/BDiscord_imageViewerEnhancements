...
var imageViewerEnhancements = function () {
	...
	that.start = function () { console.log("ImageViewer Enhancements loaded!") };
	that.load = function () {  };
	that.unload = function () {};
	that.stop = function () {};
	that.getSettingsPanel = function () { return ""; };

	that.getName = function () { return "ImageViewer Enhancements"; };
	that.getDescription = function () { return "Enhances the standard image viewer with new features."; };
	that.getVersion = function () { return "0.1.0"; };
	that.getAuthor = function () { return "DeppImAll"; };
